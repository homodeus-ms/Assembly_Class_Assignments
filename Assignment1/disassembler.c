...
#define print(hex, mnemo, mode, h, l) sprintf(out_buffer64, "OPCODE=%X[%s %s] OPERAND=%s %s", hex, mnemo, mode, h, l)
...
static const unsigned char* s_mnemonics2[ARR_SIZE * ARR_SIZE] = {
    "brk i", "ora (zp,x)", "", "", "", "ora zp", "asl zp", "", "php i", "ora #", "asl A", "", "", "ora a", "asl a", "",
        ...
        "bmi r", "and (zp),y", "", "", "", "and z,x", "rol z,x", "", "sec i", "and a,y", "", "", "", "and a,x", "rol a,x", "",
        "rti i", "eor (zp,x)", "", "", "", "eor zp", "lsr zp", "", "pha i", "eor #", "lsr A", "", "jmp a", "eor a", "lsr a", "",
        "bvc r", "eor (zp),y", "", "", "", "eor z,x", "lsr z,x", "", "cli i", "eor a,y", "", "", "", "eor a,x", "lsr a,x", "",
        "rts i", "adc (zp,x)", "", "", "", "adc zp", "ror zp", "", "pla i", "adc #", "ror A", "", "jmp (a)", "adc a", "ror a", "",
        "bvs r", "adc (zp),y", "", "", "", "adc z,x", "ror z,x", "", "sei i", "adc a,y", "", "", "", "adc a,x", "ror a,x", "",
        "", "sta (zp,x)", "", "", "sty zp", "sta zp", "stx zp", "", "dey i", "", "txa i", "", "sty a", "sta a", "stx a", "",
        "bcc r", "sta (zp),y", "", "", "sty zp,x", "sta z,x", "stx z,y", "", "tya i", "sta a,y", "txs i", "", "", "sta a,x", "", "",
...
const unsigned char* disassemble(char* out_buffer64, const unsigned char* mem)
{
    ...
    opcode = s_mnemonics2[index_y * ARR_SIZE + index_x];
